...
export type ScheduleQueryVariables = Exact<{
  todaySeconds: Scalars['Int'];
  page?: Maybe<Scalars['Int']>;
}>;


export type ScheduleQuery = { Page?: Maybe<{ airingSchedules?: Maybe<Array<Maybe<(
      Pick<AiringSchedule, 'id'>
      & { media?: Maybe<MediaFragment> }
    )>>>, pageInfo?: Maybe<Pick<PageInfo, 'currentPage' | 'hasNextPage'>> }> };
